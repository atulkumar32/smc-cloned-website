...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 'prod-exported-01',
    slug: 'vorano-global-export-spec-tactical-backpack',
    name: 'Vorano Global Export-Spec Heavy-Duty Backpack',
    subtitle: 'Built for international military and cargo durability standards',
    brand: 'VORANO EXPORT DIVISION',
    category: 'exported',
